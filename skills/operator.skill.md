...
- **Output (commit):** `<subject>-operability-review.md` (template-valid) recording verdict + findings + `openItems`, plus infrastructure-runway recommendations and observability implications.
