# Architectural Runway Register Template — `products/<product-slug>/architecture-runway.md`
...
is architecture-scoped and belongs under the product's `art/<art-slug>/program-backlog/` folder, not beside the
backlog folders.
