...
| Sprint plan | `sprint-N/plan.md` | [sprint-plan.artifact.schema.json](../../../../harness/contracts/artifact/sprint-plan.artifact.schema.json) + [sprint-plan.artifact-template.md](artifacts/sprint-plan.artifact-template.md) |
| Story (business) | `sprint-N/stories/S-N.md` | [story.artifact.schema.json](../../../../harness/contracts/artifact/story.artifact.schema.json) + [story.artifact-template.md](../product-owner/artifacts/story.artifact-template.md) |
...
| QA sign-off | `sprint-N/qa/S-N-signoff.md` | [qa-signoff.artifact.schema.json](../../../../harness/contracts/artifact/qa-signoff.artifact.schema.json) + [qa-signoff.artifact-template.md](../quality-engineer/artifacts/qa-signoff.artifact-template.md) |
| Daily sync | `sprint-N/daily-DD.md` | [daily.artifact.schema.json](../../../../harness/contracts/artifact/daily.artifact.schema.json) + [daily.artifact-template.md](artifacts/daily.artifact-template.md) |
| Sprint retro | `sprint-N/retro.md` | [retro.artifact.schema.json](../../../../harness/contracts/artifact/retro.artifact.schema.json) + [retro.artifact-template.md](artifacts/retro.artifact-template.md) |
| Sprint progress | `sprint-N/progress.md` | [progress.artifact.schema.json](../../../../harness/contracts/artifact/progress.artifact.schema.json) + [progress.artifact-template.md](artifacts/progress.artifact-template.md) |
| Gate decision backlog | `sprint-N/gate-decisions.md` | [gate-decisions.artifact.schema.json](../../../../harness/contracts/artifact/gate-decisions.artifact.schema.json) + [gate-decisions.artifact-template.md](artifacts/gate-decisions.artifact-template.md) |
...
| Team Kanban (rendered) | `kanban/team-sprint-N.md` | [kanban-team.artifact.schema.json](../../../../harness/contracts/artifact/kanban-team.artifact.schema.json) + [kanban-team.artifact-template.md](artifacts/kanban-team.artifact-template.md) |
